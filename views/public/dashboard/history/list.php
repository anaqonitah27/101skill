                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="example" class="display" style="min-width: 845px">
                                ...
                                <tbody>
                                    <?php $no = 1;
                                    foreach ($invoice->getAllInvoice() as $inv) : ?>
                                        <tr>
                                            <td><?= $no; ?></td>
                                            ...
                                            <td><?= $inv->name ?></td>
                                            <td>
                                                <a href="<?= $uriHelper->baseUrl('index.php?page=dashboard&content=history&menu=detail&id=' . $inv->invoice_id) ?>" class="btn btn-info light btn-sm">Detail klaim</a>
                                            </td>
                                        </tr>
                                    <?php $no++;
                                    endforeach; ?>
