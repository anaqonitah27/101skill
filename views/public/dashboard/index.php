...
$totalClassroom = $classroom->countRows();
$favorite = $classroom->getFavoriteClassroom();
$latest = $classroom->getLatestTransactions();
$orders = $classroom->getTotalOrders();
?>
                            ...
                            <div class="card-body p-4">
                                <div class="media ai-icon d-flex">
                                    ...
                                    <div class="media-body">
                                        <h3 class="mb-0 text-black"><span class="counter ms-0"><?= $totalClassroom ?></span></h3>
                        ...
                        <div class="widget-stat card">
                            <div class="card-body p-4">
                                <div class="media ai-icon d-flex">
                                    ...
                                    <div class="media-body">
                                        <h3 class="mb-0 text-black"><span class="counter ms-0"><?= $orders ?></span></h3>
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    ...
                                    <div class="card-body pt-3">
                                        <?php foreach ($favorite as $list) : ?>
                                            <div class="media mb-3 pb-3 items-list-2 align-items-center">
                                                <a href="javascript:void(0);"><img class="img-fluid rounded me-3" width="85" src="<?= $uriHelper->assetUrl('images/classroom_thumbnails/' . $list->thumbnail) ?>" alt="DexignZone"></a>
                                                <div class="ml-3 media-body col-12 px-0">
                                                    <h3 class="mt-0 mb-3 sub-title"><a href="<?= $uriHelper->baseUrl('index.php?page=dashboard&content=classroom&menu=detail&id=' . $list->id) ?>"><?= $list->title ?></a></h3>
                                                    <span class="font-w500 mb-3"><?= $list->favorit ?> item terjual</span>
                                                </div>
                                            </div>
                                        <?php endforeach; ?>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body pt-3">
                                        <?php foreach ($latest as $list) : ?>
                                            <div class="media mb-3 pb-3 items-list-2 align-items-center">
                                                <a href="javascript:void(0);"><img class="img-fluid rounded me-3" width="85" src="<?= $uriHelper->assetUrl('images/profile/' . $list->photo) ?>" alt="DexignZone"></a>
                                                <div class="ml-3 media-body col-12 px-0">
                                                    <h3 class="mt-0 mb-3 sub-title"><a href="<?= $uriHelper->baseUrl('index.php?page=dashboard&content=order&menu=detail&invoice_id=id_invoice') ?>"><?= $list->name ?></a></h3>
                                                    <span class="font-w500 mb-3">baru saja membeli kelas : <span class="text-danger"> <?= $list->title ?></span></span>
                                                </div>
                                            </div>
                                        <?php endforeach; ?>
                                    </div>
