                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="form-group mb-3 pb-3">
                                        ...
                                        <input autocomplete="off" type="text" class="form-control solid" placeholder="Instalasi composer dan komponen lainnya" name="title" value="<?= (isset($_POST['title']) ? $_POST['title'] : '') ?>">
                                    </div>
                                    <div class="form-group mb-3 pb-3">
                                        <label class="font-w600">Deskripsi Materi <span class="text-danger">*</span></label>
                                        <textarea placeholder="Pada materi ini kita akan belajar untuk melakukan instalasi laravel melalui package composer" autocomplete="off" name="description" rows="5" class="form-control solid"><?= (isset($_POST['description']) ? $_POST['description'] : '') ?></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label class="font-w600">Konten Materi <span class="text-danger">*</span></label>
                                        <textarea id="ckeditor1" autocomplete="off" name="content" rows="5" class="form-control solid"><?= (isset($_POST['content']) ? $_POST['content'] : '') ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="loadmore-content" id="uploadItemContent">
                                        <div class="row">
                                            ...
                                            <div class="card-footer">
                                                <button type="submit" name="submit" class="btn btn-primary light btn-block rounded">Tambah Materi baru</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
